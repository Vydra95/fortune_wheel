...
const prizes = [
  ...
  {
    text: "Университет Аапда Митра готовит волонтеров на случай стихийных бедствий. И вы тоже подготовьтесь, сейчас начнёт штормить... Только если вас смоет за борт лайнера, скучать по вам будут! Так что пристегнитесь-ка.",
    color: "hsl(350 60% 52%)",
  },
  {
    text: "Кроссовки Ионеску были заперты на арене, но всё равно ушли по своим делам. Возможно, вы что-то потеряете. Обратитесь в полицию Лос-Анджелеса!",
    color: "hsl(91 43% 54%)",
  },
  {
  ...
  {
    text: "Останавливаетесь пописать каждые десять минут? Кашляете как карлик, давящийся горящей тряпкой? Проверьте-ка здоровье и ешьте побольше черешни, ведь она снижает воспаление!",
    color: "hsl(140 36% 74%)",
  },
  {
    text: "Видите, там из каменной ванны торчат чьи-то ноги? А бассейн инфинити и удачно расположенную в небе птицу? Всё это на деньги, полученные в качестве инфлюэнсеров. И именно такое богатство вас ожидает! Застряла в раю...",
    color: "hsl(140 36% 74%)",
  },
  {
